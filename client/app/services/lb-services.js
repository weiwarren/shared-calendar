  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Event#schedulerList
         * @methodOf lbServices.Event
         *
         * @description
         *
         ...
         */
        "schedulerList": {
          url: urlBase + "/events/schedulerList",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Event#groupBy
         * @methodOf lbServices.Event
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Property.eventTypes.findById() instead.
        "prototype$__findById__eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Property.eventTypes.destroyById() instead.
        "prototype$__destroyById__eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Property.eventTypes.updateById() instead.
        "prototype$__updateById__eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Property.eventTypes() instead.
        "prototype$__get__eventTypes": {
          isArray: true,
          url: urlBase + "/properties/:id/eventTypes",
          method: "GET"
        },

        // INTERNAL. Use Property.eventTypes.create() instead.
        "prototype$__create__eventTypes": {
          url: urlBase + "/properties/:id/eventTypes",
          method: "POST"
        },

        // INTERNAL. Use Property.eventTypes.destroyAll() instead.
        "prototype$__delete__eventTypes": {
          url: urlBase + "/properties/:id/eventTypes",
          method: "DELETE"
        },

        // INTERNAL. Use Property.eventTypes.count() instead.
        "prototype$__count__eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Property#withCategories
         * @methodOf lbServices.Property
         *
         * @description
         *
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Property.eventTypes
     * @header lbServices.Property.eventTypes
     * @object
     * @description
     *
     * The object `Property.eventTypes` groups methods
     * manipulating `EventType` instances related to `Property`.
     *
     * Call {@link lbServices.Property#eventTypes Property.eventTypes()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries eventTypes of property.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.eventTypes = function() {
          ...
          var action = TargetResource["::get::property::eventTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Property.eventTypes#count
         * @methodOf lbServices.Property.eventTypes
         *
         * @description
         *
         * Counts eventTypes of property.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.eventTypes.count = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::count::property::eventTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Property.eventTypes#create
         * @methodOf lbServices.Property.eventTypes
         *
         * @description
         *
        ...
        R.eventTypes.create = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::create::property::eventTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Property.eventTypes#destroyAll
         * @methodOf lbServices.Property.eventTypes
         *
         * @description
         *
        ...
        R.eventTypes.destroyAll = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::delete::property::eventTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Property.eventTypes#destroyById
         * @methodOf lbServices.Property.eventTypes
         *
         * @description
         *
        ...
        R.eventTypes.destroyById = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::destroyById::property::eventTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Property.eventTypes#findById
         * @methodOf lbServices.Property.eventTypes
         *
         * @description
         *
        ...
        R.eventTypes.findById = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::findById::property::eventTypes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Property.eventTypes#updateById
         * @methodOf lbServices.Property.eventTypes
         *
         * @description
         *
        ...
        R.eventTypes.updateById = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::updateById::property::eventTypes"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Property.eventTypes.findById() instead.
        "::findById::property::eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Property.eventTypes.destroyById() instead.
        "::destroyById::property::eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Property.eventTypes.updateById() instead.
        "::updateById::property::eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Property.eventTypes() instead.
        "::get::property::eventTypes": {
          isArray: true,
          url: urlBase + "/properties/:id/eventTypes",
          method: "GET"
        },
        ...
        // INTERNAL. Use Property.eventTypes.create() instead.
        "::create::property::eventTypes": {
          url: urlBase + "/properties/:id/eventTypes",
          method: "POST"
        },

        // INTERNAL. Use Property.eventTypes.destroyAll() instead.
        "::delete::property::eventTypes": {
          url: urlBase + "/properties/:id/eventTypes",
          method: "DELETE"
        },

        // INTERNAL. Use Property.eventTypes.count() instead.
        "::count::property::eventTypes": {
          url: urlBase + "/properties/:id/eventTypes/count",
          method: "GET"
        },
      }
...
/**
 * @ngdoc object
 * @name lbServices.Tier
 * @header lbServices.Tier
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Tier` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Tier#create
         * @methodOf lbServices.Tier
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Tier` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/tiers",
         ...
         */
        "findById": {
          url: urlBase + "/tiers/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Tier#find
         * @methodOf lbServices.Tier
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/tiers/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Tier#updateAll
         * @methodOf lbServices.Tier
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/tiers/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Tier#deleteById
         * @methodOf lbServices.Tier
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Tier#prototype$updateAttributes
         * @methodOf lbServices.Tier
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Tier#updateOrCreate
         * @methodOf lbServices.Tier
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Tier#destroyById
         * @methodOf lbServices.Tier
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Tier#removeById
         * @methodOf lbServices.Tier
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Tier#modelName
    * @propertyOf lbServices.Tier
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Tier`.
    */
...
/**
 * @ngdoc object
 * @name lbServices.Duration
 * @header lbServices.Duration
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Duration` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/durations/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.Duration#create
         * @methodOf lbServices.Duration
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Duration` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/durations",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Duration#upsert
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#exists
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#findById
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#findOne
         * @methodOf lbServices.Duration
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/durations/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Duration#updateAll
         * @methodOf lbServices.Duration
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/durations/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Duration#deleteById
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#count
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#prototype$updateAttributes
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#updateOrCreate
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#update
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#destroyById
         * @methodOf lbServices.Duration
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Duration#removeById
         * @methodOf lbServices.Duration
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Duration#modelName
    * @propertyOf lbServices.Duration
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Duration`.
    */
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Test#calendarList
         * @methodOf lbServices.Test
         *
         * @description
         *
         ...
         */
        "calendarList": {
          url: urlBase + "/tests/calendarList",
          method: "GET"
        },
      }
    );
