    ...
    .directive('nvFileSelect', ['$parse', 'FileUploader', function($parse, FileUploader) {
      return {
        link: function(scope, element, attributes) {
          ...
          */
          //warren: updated using watch to cater scenarios where upload containerid is async loaded
          scope.$watch(attributes.uploader, function(nv,ov){
            if(nv){
              console.log(nv);
              if (!(nv instanceof FileUploader)) {
                throw new TypeError('"Uploader" must be an instance of FileUploader');
              }
              else{
